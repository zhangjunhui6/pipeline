...
--               F:/piplinecpu/pipeline/pipeline.srcs/sources_1/ip/irom/irom_sim_netlist.vhdl
-- Design      : irom
...
\synth_options.dist_mem_inst\: entity work.irom_dist_mem_gen_v8_0_13_synth
     port map (
      ...
      spo(9) => \^spo\(19),
      spo(8 downto 7) => \^spo\(17 downto 16),
      spo(6) => \^spo\(12),
      spo(5 downto 0) => \^spo\(5 downto 0)
    );
end STRUCTURE;
